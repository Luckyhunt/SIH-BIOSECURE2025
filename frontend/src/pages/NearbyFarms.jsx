      ...
      <header className="bg-purple-600 text-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold">Visitor Dashboard</h1>
          </div>
        ...
        <section className="bg-white rounded-xl shadow-sm p-4 border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div className="md:col-span-4">
              <button className="w-full px-4 py-3 rounded-lg bg-purple-700 text-white hover:bg-purple-800">Search Farms</button>
            </div>
          </div>
        </section>
